...
const Postphoto = ({ close }) => {
  ...
  const handlePostPhoto = () => {
    ...
    />
      ...
      <img className='w-full h-96' src={selected.name} alt=''/></div> : <div className='flex w-full justify-center'><div className='p-2 cursor-pointer border flex items-center justify-center gap-1 w-1/2 rounded-md border-cta text-cta hover:bg-cta hover:text-white'>
