...
const Message = () => {
    ...
    const fetchUsers = async () => {
        try {
            const response = await axios.get('http://192.168.1.4:8080/api/auth/users/descending');
    ...
    const fetchOtps = async () => {
        try {
            const response = await axios.get('http://192.168.1.4:8080/api/auth/otps/descending');
