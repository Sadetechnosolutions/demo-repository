...
const Friendlist = () => {
  ...
  return (
    <div className=' flex w-full items-center justify-center'>
      <div className='w-5/6 drop bg-white shadow-lg h-auto w-3/5 flex-col '>
      ...
      <div className='flex items-center gap-2'>
        ...
        <div className='flex flex-wrap gap-8 items-center p-2'>
            {Friends.slice().reverse().map((friend)=>(
                <div key={friend.id}>
            <div className='flex flex-col rounded-md border border-gray-200 rounded-md w-[18.5rem]'>
<div className="relative">
  ...
  <div className="absolute -mt-10 ml-2 flex  items-center">
    <img className="rounded-full w-16 h-16 border-2 border-white" alt="" src={friend.img} />
            ...
            <div className='flex items-start flex-col'>
                ...
                <span><span className='text-xs'>Since: {friend.joined}</span> </span>
            </div>
            ...
            <div className='px-2 py-1 text-cta border hover:bg-cta hover:text-white flex justify-center rounded-md cursor-pointer border-cta'><span className=''>Message</span></div>
         </div>
         </div>
                </div>
            ))}
